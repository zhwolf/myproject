...
from whoosh.fields import Schema, IDLIST, TEXT, KEYWORD, NUMERIC, BOOLEAN, DATETIME, NGRAM, NGRAMWORDS,STORED
...
class WhooshSearchBackend(BaseSearchBackend):
    ...
    def setup(self):
        ...
        self.parser = MultifieldParser([self.content_field_name, ], schema=self.schema)
...
def ChineseAnalyzer(stoplist=STOP_WORDS,minsize=1, stemfn=stem, cachesize=5000):
