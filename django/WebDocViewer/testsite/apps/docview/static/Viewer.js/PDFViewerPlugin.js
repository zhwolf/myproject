...
function PDFViewerPlugin() {
    ...
    function init(callback) {
        ...
        pluginCSS.setAttribute("href", "/static/Viewer.js/PDFViewerPlugin.css");
    ...
    this.initialize = function (viewContainer, location) {
        ...
        init(function () {
            PDFJS.workerSrc = "/static/Viewer.js/pdf.worker.js";
